# Back Matter: Tutorial, Appendices and Index
...
- The Tutorial's video lesson (Lesson 4) has been updated to the current
  file-based AVI recording workflow; tape-deck steps are flagged as legacy.
  See also [Section Nine — Video Output](../09-video-output/README.md).
...
- Appendix IV's Environment Units table contained several descriptions
  ...
  been corrected.
- The original page-number index (Appendix X) is replaced by a
  topic-to-chapter table, since page numbers do not apply to the Markdown
  edition.
...
Next: [Chapter 32 — HVE Tutorial](32-tutorial.md) →
